      ...
      {props.laporan.length > 0 ? (
        <>
          <div className="m-5 my-4 grid grid-cols-2">
            <div>
              <h1 className="text-2xl font-bold mb-3">Laporan Bulanan Toko {props.laporan[0].namaToko}</h1>
              <div className="flex">
                <Link
        ...
        <>
          <h1>Tidak ada Laporan penjualan</h1>
          <Link
            href={`/admin/laporan/${props.toko.id}`}
            className="bg-gray-600 text-white p-2 hover:bg-gray-700 rounded-lg mx-1"
          >
            Kembali
          </Link>
