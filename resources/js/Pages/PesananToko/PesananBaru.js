...
function Show({ dataShow, props, handleCloseShow, setRinciOrder, setTotalPages, currentPage }) {
  ...
  const handleUbahStatusBatal = (statusOrder, idRinciOrder) => {
    ...
    router.post("/ubah-status-dibatalkan", data);
            ...
            <div className="w-full md:w-1/2 px-4 mt-6 md:mt-0 overflow-x-auto">
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <dl className="grid grid-cols-2 gap-x-4 gap-y-2">
                  ...
                  <div className="col-span-1 text-gray-600">Nomor Telepon</div>
                  <div className="col-span-1 text-gray-800 overflow-x-auto">081234567890</div>
              ...
              <div className="mt-1">
                ...
                <textarea onChange={(e) => setAlasanPembatalan(e.target.value)} name="alasanPembatalan" id="alasanPembatalan" type="text" className="w-full h-16" />
                {props.errors.alasanPembatalan && <p className="text-red-600">{props.errors.alasanPembatalan}</p>}
              </div>
            </div>
          </div>
        </main>
