...
const LaporanHarian = (props) => {
  ...
  const data = {
    labels: props.laporan.map((data) => data.hour),
    datasets: [
      {
        label: 'Sales',
  ...
  return (
    <>
      ...
      {/* <div className="h-2 bg-sky-600 top-0 w-full min-w-full overflow-x-auto"></div> */}
      <div className="container mx-2">
        ...
        <div className="overflow-x-auto">
          <table className="table-auto relative shadow-md sm:rounded-lg w-full text-sm text-left text-gray-500 dark:text-gray-400">
